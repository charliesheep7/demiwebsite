...
export function AppStoreButton({
  size = 'lg',
  href = 'https://apps.apple.com/app/demimanifest/id...',
  className = '',
}: {
  size?: Size
  href?: string
  ...
  return (
    <a
      ...
      className={`group relative inline-flex items-center ${sizeClasses[size]} text-ink from-yel-200 to-yel-300 font-ui shadow-sd-glow animate-gold-breathe rounded-full bg-gradient-to-br font-bold tracking-[0.18em] uppercase transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 ${className}`}
    >
